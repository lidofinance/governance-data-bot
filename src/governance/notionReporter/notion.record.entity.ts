...
export class NotionVoteEntity extends NotionEntity {
  ...
  properties() {
    return {
      ...
      Res4: NotionVoteEntity.propertiesNames.Res4.value(this.vote.result4),
      ...
      Choice4: NotionVoteEntity.propertiesNames.Choice4.value(this.vote.choice4, {}),
...
export function voteFromNotionProperties(properties): VoteEntity {
  return {
    ...
    result4: properties.Res4.number,
    ...
    choice4: properties.Choice4.rich_text[0]?.text.content,
